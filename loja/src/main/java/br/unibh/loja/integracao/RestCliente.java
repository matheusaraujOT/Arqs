...
public class RestCliente {
	...
	@Path("{id}")
	@Produces(MediaType.APPLICATION_JSON)
	public Cliente buscarCliente(@PathParam("id") final Long id) throws Exception {
		return sc.find(id);
	}
	...
	@Path("perfil/{perfil}")
	@Produces(MediaType.APPLICATION_JSON)
	public List<Cliente> listarClientesPerfil(@PathParam("perfil") final String perfil) throws Exception {
	...
	@Path("nome/{nome}")
	@Produces(MediaType.APPLICATION_JSON)
	public List<Cliente> listarClientesNome(@PathParam("nome") final String nome) throws Exception {
